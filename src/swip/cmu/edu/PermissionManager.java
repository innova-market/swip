...
public class PermissionManager
{
	...
	private static void loadPermissions()
	{
		...
		permissionsById.put("READ_CONTACTS", new Permission("Read Contacts",
				"Allows an application to read the user's contacts data.", true));
		...
		permissionsById.put("WAKE_LOCK", new Permission("Wake Lock",
				"Allows using PowerManager WakeLocks to keep processor from sleeping or screen from dimming", false));
		...
		permissionsById.put("INTERNET", new Permission("Full Internet Access",
				"Allows applications to communicate with the internet.", false));
	}
